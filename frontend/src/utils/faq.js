export default function faq () {
    return [
        ...
        {
            question: 'Cuanto rinde un rig?',
            answer: {
                description: 'Las variables que influyen mayormente en el rendimiento son:',
                variables: [
        ...
        {
            question: 'Como cobro mi dinero?',
            answer: 'Los rigs generan un ingreso en criptomoneda que se deposita automáticamente en tu illetera virtual. Esos pagos recibidos se pueden acumular para especular con subidas en la cotización, hacer trading o cambiar por dólares o pesos. Es importante mencionar en esta sección que los equipos se entregan configurados para hacer los pagos a tu billetera con una contraseña elegida por vos. Por lo que es imposible que cualquier otra persona acceda a la configuración de los pagos de tu minero.'
        }
    ]
}